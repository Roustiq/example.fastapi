...
# commented out lines are original raw program to get data from database without ORM.
# def get_posts():
...
# commented out lines are original raw program to create data without ORM.
